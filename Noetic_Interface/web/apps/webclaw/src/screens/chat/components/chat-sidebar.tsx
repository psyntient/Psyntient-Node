            ...
            >
              <Link
                ...
                className={cn(
                  ...
                  'w-full pl-1.5 justify-start gap-2.5',
                )}
              >
                <img src="/brand/psyntient-mark.png" alt="" className="size-6" />
                <span className="font-serif text-[13px] tracking-[0.18em] text-primary-950">
                  PSYNTIENT
                </span>
                <span className="ml-auto font-mono text-[10px] tracking-[0.2em] text-primary-600">
                  NODE
                </span>
              </Link>
            </motion.div>
          ) : (
            <Link to="/new" className="flex w-full items-center justify-center">
              <img src="/brand/psyntient-mark.png" alt="Psyntient" className="size-6" />
            </Link>
          )}
        </AnimatePresence>
        <TooltipProvider>
      ...
      <div className="px-2 py-3 border-t border-primary-200 bg-primary-100">
        ...
        >
          <Button
            ...
            title={isCollapsed ? 'What can Cortex do?' : undefined}
